                            ...
                            <div className="block-content block-content-full">
                                <div className="row gutters-tiny">
                                    <div className="col-6">
                                        ...
                                        <a className="block block-rounded block-themed bg-default" href="javascript:void(0)">
                                    ...
                                    <div className="col-6">
                                        ...
                                        <a className="block block-rounded block-themed bg-danger" href="javascript:void(0)">
                                            <div className="block-content text-center">
                                    ...
                                    <div className="col-6">
                                        ...
                                        <a className="block block-rounded block-themed bg-success mb-0" href="javascript:void(0)">
                                            <div className="block-content text-center">
                                    ...
                                    <div className="col-6">
                                        ...
                                        <a className="block block-rounded block-themed bg-warning mb-0" href="javascript:void(0)">
                                            <div className="block-content text-center">
