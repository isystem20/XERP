        ...
        return (
           <aside id="side-overlay" className="font-size-sm">
                ...
                <div className="content-header border-bottom">
                    ...
                    <div className="ml-2">
                        <a className="link-fx text-dark font-w600" href="javascript:void(0)">Adam McCoy</a>
                    </div>
                    
                    <a className="ml-auto btn btn-sm btn-dual" href="javascript:void(0)" data-toggle="layout" data-action="side_overlay_close">
                                        ...
                                        <ul className="nav-items mb-0">
                                            <li>
                                                <a className="media py-2" href="javascript:void(0)">
                                                    <div className="mr-3 ml-2 overlay-container overlay-bottom">
                                                        <img className="img-avatar img-avatar48" src="assets/media/avatars/avatar8.jpg" alt="" />
                                                        <span className="overlay-item item item-tiny item-circle border border-2x border-white bg-success"></span>
                                                    </div>
                                                    <div className="media-body">
                                                        <div className="font-w600">Andrea Gardner</div>
                                            ...
                                            <li>
                                                <a className="media py-2" href="javascript:void(0)">
                                                    ...
                                                    <div className="media-body">
                                                        <div className="font-w600">Jose Mills</div>
                                            ...
                                            <li>
                                                <a className="media py-2" href="javascript:void(0)">
                                                    ...
                                                    <div className="media-body">
                                                        <div className="font-w600">Carol Ray</div>
                                            ...
                                            <li>
                                                <a className="media py-2" href="javascript:void(0)">
                                                    ...
                                                    <div className="media-body">
                                                        <div className="font-w600">Megan Fuller</div>
                                            ...
                                            <li>
                                                <a className="media py-2" href="javascript:void(0)">
                                                    <div className="mr-3 ml-2 overlay-container overlay-bottom">
                                                        <img className="img-avatar img-avatar48" src="assets/media/avatars/avatar12.jpg" alt="" />
                                                        <span className="overlay-item item item-tiny item-circle border border-2x border-white bg-warning"></span>
                                                    </div>
                                                    <div className="media-body">
                                                        <div className="font-w600">Jose Parker</div>
                                        ...
                                        <form action="be_pages_dashboard.html" method="POST" onsubmit="return false;">
                                            <div className="form-group">
                                                ...
                                                <div className="custom-control custom-switch mb-1">
                                                    <input type="checkbox" className="custom-control-input" id="so-settings-check1" name="so-settings-check1" checked />
                                                    <label className="custom-control-label" for="so-settings-check1">Show your status to all</label>
                                                </div>
                                            </div>
                                            <hr />
                                            <div className="form-group">
                                                ...
                                                <div className="custom-control custom-switch mb-1">
                                                    <input type="checkbox" className="custom-control-input" id="so-settings-check2" name="so-settings-check2" checked />
                                                    <label className="custom-control-label" for="so-settings-check2">Keep up to date</label>
                                                </div>
                                            </div>
                                            <hr />
                                            <div className="form-group">
                                                ...
                                                <div className="custom-control custom-switch mb-1">
                                                    <input type="checkbox" className="custom-control-input" id="so-settings-check3" name="so-settings-check3" checked />
                                                    <label className="custom-control-label" for="so-settings-check3">Email Notifications</label>
                                                </div>
                                                <div className="custom-control custom-switch mb-1">
                                                    <input type="checkbox" className="custom-control-input" id="so-settings-check4" name="so-settings-check4" checked />
                                                    <label className="custom-control-label" for="so-settings-check4">SMS Notifications</label>
                                                </div>
                                            </div>
                                            <hr />
                                            <div className="form-group">
                                                ...
                                                <div className="custom-control custom-switch mb-1">
                                                    <input type="checkbox" className="custom-control-input" id="so-settings-check5" name="so-settings-check5" checked />
                                    ...
                                    <div className="block-content">
                                        <div className="row items-push pull-t">
                                            <div className="col-6">
                                                ...
                                                <a className="link-fx font-size-h3 font-w300" href="javascript:void(0)">22.030</a>
                                            </div>
                                            <div className="col-6">
                                                <div className="font-w700 text-uppercase">Balance</div>
                                                <a className="link-fx font-size-h3 font-w300" href="javascript:void(0)">$4.589,00</a>
                                            </div>
                                        </div>
                                    </div>
